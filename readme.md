...
## Dependencies
Run the following command to install required libraries used in this project: 
```
...
See also the list of [contributors](https://github.com/AdneneBoumessouer/AutPr/contributors) who participated in this project.
