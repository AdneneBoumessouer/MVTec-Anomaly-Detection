...
def resmaps_ssim(imgs_input, imgs_pred):
    ...
    for i in range(len(imgs_input)):
        ...
        _, resmap = ssim(img_input, img_pred, win_size=11, gaussian_weights=True, sigma=1.5, full=True)
...
def resmaps_mssim(imgs_input, imgs_pred):
    ...
    for i in range(len(imgs_input)):
        ...
        _, resmap = ssim(img_input, img_pred, multichannel=True, win_size=11, gaussian_weights=True, sigma=1.5, full=True)
        resmaps[i] = 1 - resmap
