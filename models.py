...
def build_model(architecture, channels=3):
    if architecture == "mvtec":
        ...
        # Encode-----------------------------------------------------------
        x = keras.layers.Conv2D(32, (4, 4), strides=2, activation='relu',
        ...
        x = keras.layers.Conv2D(64, (3, 3), strides=1,
                                activation='relu', padding='same')(x)
        x = keras.layers.Conv2D(128, (4, 4), strides=2,
                                activation='relu', padding='same')(x)
        x = keras.layers.Conv2D(64, (3, 3), strides=1,
                                activation='relu', padding='same')(x)
        x = keras.layers.Conv2D(32, (3, 3), strides=1,
        ...
        # Decode---------------------------------------------------------------------
        x = keras.layers.Conv2D(32, (3, 3), strides=1, activation='relu',
